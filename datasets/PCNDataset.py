...
id2cls = {"02691156":0, "02933112":1, "02958343":2,"03001627":3,"03636649":4,
          "04256520":5,"04379243":6,"04530566":7}
...
class PCN(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        data['taxonomy_id'] = sample['taxonomy_id']
        data['obj_cls'] = id2cls[sample['taxonomy_id']]
        data['model_id'] = sample['model_id']
        return data
